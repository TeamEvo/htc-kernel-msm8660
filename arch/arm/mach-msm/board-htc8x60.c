/* arch/arm/mach-msm/board-htc8x60.c
 *
...
static struct platform_device htc8x60_3Dpanel_device = {
	.name = "panel_3d",
	.id = -1,
};
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
	...
	RPM_LDO(PM8058_L10, 0, 1, 0, 2800000, 2850000, LDO300HMIN),
	RPM_LDO(PM8058_L11, 0, 1, 0, 1800000, 1800000, LDO150HMIN),
	RPM_LDO(PM8058_L12, 0, 1, 0, 1800000, 3200000, LDO150HMIN),
...
static struct bcm_bt_lpm_platform_data bcm_bt_lpm_pdata = {
	.gpio_wake = HTC8X60_GPIO_BT_CHIP_WAKE,
	.gpio_host_wake = HTC8X60_GPIO_BT_HOST_WAKE,
