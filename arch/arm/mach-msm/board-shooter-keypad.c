...
static struct gpio_event_direct_entry shooter_keypad_input_map[] = {
	...
	{ HTC8X60_GPIO_KEY_VOL_UP,	KEY_VOLUMEUP		},
	{ HTC8X60_GPIO_KEY_VOL_DOWN,	KEY_VOLUMEDOWN		},
	{ HTC8X60_GPIO_KEY_CAM_STEP1,	KEY_HP			},
	{ HTC8X60_GPIO_KEY_CAM_STEP2,	KEY_CAMERA		},
};
...
static void shooter_gpio_event_input_init(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(HTC8X60_GPIO_KEY_VOL_UP, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(HTC8X60_GPIO_KEY_VOL_DOWN, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(HTC8X60_GPIO_KEY_CAM_STEP1, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(HTC8X60_GPIO_KEY_CAM_STEP2, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
};
